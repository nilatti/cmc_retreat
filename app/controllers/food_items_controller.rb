class FoodItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @food_item.save
        format.html { redirect_to food_committee_show, notice: 'Food item was successfully created.' }
        format.json { render json: food_committee_show, status: :created, location: @food_item }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @food_item.update_attributes(params[:food_item])
        format.html { redirect_to food_committee_show, notice: 'Food item was successfully updated.' }
